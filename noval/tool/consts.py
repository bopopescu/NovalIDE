from noval.util.constants import _,ID_MRU_FILE1,ID_MRU_FILE20
...
EDITOR_CONTENT_PANE_NAME = "notebook_content"
TOOLBAR_PANE_NAME = "toolbar"


TabAlignTop = 1
TabAlignBottom = 2
DEBUGGER_PAGE_COMMON_METHOD = "StopAndRemoveUI"

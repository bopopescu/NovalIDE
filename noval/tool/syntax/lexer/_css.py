...
#---- Syntax Style Specs ----#
    SYNTAX_ITEMS = [ 
         ...
         (stc.STC_CSS_DIRECTIVE,            "Directive",                _("Directive"),             'directive_style'),
         (stc.STC_CSS_DOUBLESTRING,         "DoubleString",             _("Double String"),         'string_style'),
         (stc.STC_CSS_ID,                   "Id",                       _("Id"),                    'scalar_style'),
         (stc.STC_CSS_IDENTIFIER,           "Identifier",               _("Identifier"),            'keyword_style'),
         (stc.STC_CSS_IDENTIFIER2,          "Identifier2",              _("Identifier2"),           'keyword3_style'),
         (stc.STC_CSS_IMPORTANT,            "Important",                _("Important"),             'error_style'),
         (stc.STC_CSS_OPERATOR,             "Operator",                 _("Operator"),              'operator_style'),
         (stc.STC_CSS_PSEUDOCLASS,          "Pseudoclass",              _("Pseudoclass"),           'scalar_style'),
         (stc.STC_CSS_SINGLESTRING,         "SingleString",             _("Single String"),         'string_style'),
         (stc.STC_CSS_TAG,                  "Tag",                      _("Tag"),                   'keyword_style'),
         (stc.STC_CSS_UNKNOWN_IDENTIFIER,   "UnknownIdentifier",        _("Unknown Identifier"),    'unknown_style'),
         (stc.STC_CSS_UNKNOWN_PSEUDOCLASS,  "UnknownPseudoclass",       _("Unknown Pseudoclass"),   'unknown_style'),
         (stc.STC_CSS_VALUE,                "Value",                    _("Value"),                 'char_style') 
    ]
    ...
    def GetDocIcon(self):
        return images.getCSSFileIcon()
        
    def GetSampleCode(self):
        sample_file_path = os.path.join(appdirs.GetAppDataDirLocation(),"sample","css.sample")

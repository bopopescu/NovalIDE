...
class SyntaxLexer(syndata.BaseLexer):
    ...
    SYNTAX_ITEMS = [ 
         ...
         (stc.STC_SQL_COMMENTDOCKEYWORD,        "CommentDocKeyWord",       _("Comment Doc KeyWord"),        'dockey_style'),        # 17
         ...
         (stc.STC_SQL_USER3,                    "User3",                   _("User3"),                      'keyword3_style'),      # 21
         (stc.STC_SQL_USER4,                    "User4",                   _("User4"),                      'keyword_style'),       # 22
         (stc.STC_SQL_WORD,                     "KeyWord1",                _("KeyWord1"),                   'keyword_style'),       #  5
         (stc.STC_SQL_WORD2,                    "KeyWord2",                _("KeyWord2"),                   'keyword2_style') 
    ]# 16
    def __init__(self):
        super(SyntaxLexer, self).__init__(lang.ID_LANG_SQL)
